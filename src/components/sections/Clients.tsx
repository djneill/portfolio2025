    ...
    <section className="py-32 bg-slate-800/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-slate-800/30 to-transparent z-10"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-slate-800/30 to-transparent z-10"></div>
          ...
          <div className="flex animate-scroll">
            {duplicatedClients.map((client, index) => (
              <div
                key={`${client.id}-${index}`}
                className="flex-shrink-0 mx-8 w-56 h-28 flex items-center justify-center"
              >
